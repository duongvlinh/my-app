...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(HelloWorld2View.class)) {
            nav.addItem(new SideNavItem("Hello World2", HelloWorld2View.class, LineAwesomeIcon.ADDRESS_CARD.create()));

        }
        if (accessChecker.hasAccess(HelloWorld3View.class)) {
            nav.addItem(new SideNavItem("Hello World3", HelloWorld3View.class, LineAwesomeIcon.ADDRESS_CARD.create()));
